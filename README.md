...
* [Python: Функции](https://ru.hexlet.io/courses/python-functions)
    * 2/15 Позиционные аргументы: [теория](https://ru.hexlet.io/courses/python-functions/lessons/positional-args/theory_unit), [тесты](https://ru.hexlet.io/courses/python-functions/lessons/positional-args/quiz_unit), [упражнение](https://ru.hexlet.io/courses/python-functions/lessons/positional-args/exercise_unit)
    * 3/15 Именованные аргументы: [теория](https://ru.hexlet.io/courses/python-functions/lessons/keyword-arguments/theory_unit), [тесты](https://ru.hexlet.io/courses/python-functions/lessons/keyword-arguments/quiz_unit), [упражнение](https://ru.hexlet.io/courses/python-functions/lessons/keyword-arguments/exercise_unit)
    * 4/15 Больше об именованных аргументах: [теория](https://ru.hexlet.io/courses/python-functions/lessons/more-keyword-arguments/theory_unit), [тесты](https://ru.hexlet.io/courses/python-functions/lessons/more-keyword-arguments/quiz_unit), [упражнение](https://ru.hexlet.io/courses/python-functions/lessons/more-keyword-arguments/exercise_unit)
...
__04.09.2023:__
* [Python: Автоматическое тестирование](https://ru.hexlet.io/courses/python-testing)
    * 5/12 Модульные тесты: [теория](https://ru.hexlet.io/courses/python-testing/lessons/unit-tests/theory_unit), [тесты](https://ru.hexlet.io/courses/python-testing/lessons/unit-tests/quiz_unit), [упражнение](https://ru.hexlet.io/courses/python-testing/lessons/unit-tests/exercise_unit)
